...
class Trial(nn.Module):
    ...
    def __call__(self):
        ...
        for image in self.pil_images:
            ...
            print("\033[92m[OUTPUT] The output of the model is {} \033[0m".format(torch.max(model_output)))
            


if __name__ == '__main__':
    image_folder_path = "/mnt/A4F0E4F6F0E4D01A/Shams Iqbal/VS code/Kaggle/Datasets/animal_dataset/animals/animals/bat"
